...
bool ProgramObject::Init(std::initializer_list<ShaderObject> shaderList, std::initializer_list<Binding> attribLocationBindingList, std::initializer_list<Binding> fragDataBindingList)
{
	if (m_id != 0)
		Clean();
